...
def reasign_names1(ibs, aid_list=None, old_img2_names=None, common_prefix=''):
    ...
    CommandLine:
        python -m scripts.name_recitifer rectify_names --show

    Example:
        >>> # DISABLE_DOCTEST
        >>> from scripts.name_recitifer import *  # NOQA
        >>> import wbia
...
def simple_munkres(part_oldnames):
    ...
    CommandLine:
        python -m scripts.name_recitifer simple_munkres
...
def find_consistent_labeling(grouped_oldnames, extra_prefix='_extra_name', verbose=False):
    ...
    CommandLine:
        python -m scripts.name_recitifer find_consistent_labeling
