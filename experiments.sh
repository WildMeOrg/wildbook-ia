...
GZ_HARD()
{
    ...
    python dev.py --db GZ -t best --echo-hardcase --qrid 95 112 140 183 184 253 255 289 306 316 339 340 430 441 443 444 445 446 450 451 453 454 456 460 463 465 534 550 802 803 941 1047
}
