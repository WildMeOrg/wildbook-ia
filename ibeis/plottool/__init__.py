...
if DOELSE:
    ...
    from plottool.custom_constants import (BLACK, BLUE, BRIGHT_PURPLE,
                                           ...
                                           GRAY, GREEN, LARGE, LIGHTGRAY,
                                           LIGHT_BLUE, LIGHT_GREEN,
                                           LIGHT_PURPLE, MED, ORANGE, PHI,
    ...
    from plottool.custom_figure import (LABEL_SIZE, TITLE_SIZE, cla, clf,
                                        customize_figure, customize_fontprop,
                                        figure, gca, gcf, get_ax,
    ...
    from plottool.draw_func2 import (BASE_FNUM, DARKEN, DEBUG, DF2_DIVIDER_KEY,
                                     ...
                                     scores_to_color, show_chipmatch2,
