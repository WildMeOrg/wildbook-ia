...
if DOELSE:
    ...
    from plottool.plot_helpers import (SIFT_OR_VECFIELD, del_plotdat, draw, 
                                       ...
                                       get_plotdat_dict, get_square_row_cols, 
                                       kp_info, set_plotdat,) 
    from plottool.fig_presenter import (Qt, SLEEP_TIME, VERBOSE, 
    ...
    from plottool.custom_constants import (BLACK, BLUE, BRIGHT_PURPLE, 
                                           DARK_BLUE, DARK_GREEN, DARK_ORANGE, 
                                           DARK_RED, DARK_YELLOW, DEEP_PINK, 
                                           DPI, FALSE_RED, FIGSIZE, 
                                           FIGSIZE_BIGGER, FIGSIZE_GOLD, 
                                           FIGSIZE_HUGE, FIGSIZE_MED, 
                                           FIGSIZE_SQUARE, FONTS, FontProp, 
                                           GRAY, GREEN, LARGE, LIGHT_BLUE, 
                                           LIGHT_GREEN, LIGHT_PURPLE, MED, 
                                           ORANGE, PHI, PHI_denom, PHI_numer, 
                                           PINK, PURPLE, PURPLE2, RED, SMALL, 
                                           SMALLER, SMALLEST, TRUE_BLUE, 
                                           TRUE_GREEN, UNKNOWN_PURP, WHITE, 
                                           YELLOW, golden_wh, golden_wh2,) 
    from plottool.custom_figure import (cla, clf, customize_figure, 
                                        ...
                                        set_yticks, split,) 
    from plottool.plots import (colorline, draw_time_distribution, 
                                draw_time_histogram, draw_timedelta_pie, 
                                estimate_pdf, get_good_logyscale_kwargs, 
                                interval_line_plot, interval_stats_plot, 
                                is_default_dark_bg, multi_plot, plot_densities, 
                                ...
                                word_histogram2, wordcloud, zoom_effect01,) 
    from plottool.draw_func2 import (BASE_FNUM, DARKEN, DEBUG, DF2_DIVIDER_KEY, 
                                     FALSE, LEGEND_LOCATION, SAFE_POS, TAU, 
                                     ...
                                     next_fnum, pad_axes, param_plot_iterator, 
                                     plot, plot2, plotWidget, plot_bars, 
                                     ...
                                     space_yticks, to_base255, unique_rows, 
                                     upperleft_text, upperright_text, 
                                     variation_trunctate, width_from,) 
    import utool
