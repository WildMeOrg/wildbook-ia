...
from plottool.mpl_sift import draw_sifts, render_sift_on_patch
from plottool import fig_presenter
...
if DOELSE:
    ...
    from plottool.interactions import (ExpandableInteraction, PanEvents,
    ...
    from plottool.nx_helpers import (GraphVizLayoutConfig, LARGE_GRAPH,
