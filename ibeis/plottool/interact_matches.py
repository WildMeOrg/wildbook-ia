...
class MatchInteraction2(BASE_CLASS):
    ...
    CommandLine:
        python -m ibeis.plottool.interact_matches --test-MatchInteraction2 --show


    Example:
        >>> # xdoctest: +REQUIRES(module:ibeis)
        >>> from ibeis.plottool.interact_matches import *  # NOQA
        >>> import ibeis
        >>> # build test data
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.plottool.interact_matches
        python -m ibeis.plottool.interact_matches --allexamples
        python -m ibeis.plottool.interact_matches --allexamples --noface --nosrc
    """
