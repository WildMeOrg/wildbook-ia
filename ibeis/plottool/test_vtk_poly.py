...
def rhombicuboctahedron():
    ...
    if False:
        ...
        for x in range(6):
            q = vtk.vtkQuad()
            ids = list(range((x * 4), ((x + 1) * 4)))
            print('ids = %r' % (ids,))
            xids = list(range(0, 4))
            print('xids = %r' % (xids,))
            q.GetPointIds().SetId(xids[0], ids[0])
            q.GetPointIds().SetId(xids[1], ids[1])
            q.GetPointIds().SetId(xids[2], ids[2])
            q.GetPointIds().SetId(xids[3], ids[3])
            polygon_faces.InsertNextCell(q)

        # FL
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['L'][0])  # df
        q.GetPointIds().SetId(1, vpdict['L'][3])  # uf
        q.GetPointIds().SetId(2, vpdict['F'][2])  # ul
        q.GetPointIds().SetId(3, vpdict['F'][3])  # dl
        polygon_faces.InsertNextCell(q)

        # BL
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['L'][1])
        q.GetPointIds().SetId(1, vpdict['L'][2])
        q.GetPointIds().SetId(2, vpdict['B'][2])
        q.GetPointIds().SetId(3, vpdict['B'][3])
        polygon_faces.InsertNextCell(q)

        # LU
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['L'][2])
        q.GetPointIds().SetId(1, vpdict['L'][3])
        q.GetPointIds().SetId(2, vpdict['U'][3])
        q.GetPointIds().SetId(3, vpdict['U'][2])
        polygon_faces.InsertNextCell(q)

        # LD
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['L'][0])
        q.GetPointIds().SetId(1, vpdict['L'][1])
        q.GetPointIds().SetId(2, vpdict['D'][2])
        q.GetPointIds().SetId(3, vpdict['D'][3])
        polygon_faces.InsertNextCell(q)
        ...
        # FUL
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['L'][3])
        q.GetPointIds().SetId(1, vpdict['F'][2])
        q.GetPointIds().SetId(2, vpdict['U'][3])
        polygon_faces.InsertNextCell(q)
        ...
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['L'][0])
        q.GetPointIds().SetId(1, vpdict['F'][3])
        q.GetPointIds().SetId(2, vpdict['D'][3])
        polygon_faces.InsertNextCell(q)

        # BUL
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['L'][2])
        q.GetPointIds().SetId(1, vpdict['B'][2])
        q.GetPointIds().SetId(2, vpdict['U'][2])
        polygon_faces.InsertNextCell(q)

        # BDL
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['L'][1])
        q.GetPointIds().SetId(1, vpdict['B'][3])
        q.GetPointIds().SetId(2, vpdict['D'][2])
        polygon_faces.InsertNextCell(q)
        ...
        # FUR
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['R'][3])
        q.GetPointIds().SetId(1, vpdict['F'][1])
        q.GetPointIds().SetId(2, vpdict['U'][0])
        polygon_faces.InsertNextCell(q)

        # FDR
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['R'][0])
        q.GetPointIds().SetId(1, vpdict['F'][0])
        q.GetPointIds().SetId(2, vpdict['D'][0])
        polygon_faces.InsertNextCell(q)

        # BUR
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['R'][2])
        q.GetPointIds().SetId(1, vpdict['B'][1])
        q.GetPointIds().SetId(2, vpdict['U'][1])
        polygon_faces.InsertNextCell(q)

        # BDR
        q = vtk.vtkTriangle()
        q.GetPointIds().SetId(0, vpdict['R'][1])
        q.GetPointIds().SetId(1, vpdict['B'][0])
        q.GetPointIds().SetId(2, vpdict['D'][1])
        polygon_faces.InsertNextCell(q)
        ...
        # FR
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['R'][3])  # df
        q.GetPointIds().SetId(1, vpdict['R'][0])  # uf
        q.GetPointIds().SetId(2, vpdict['F'][0])  # ul
        q.GetPointIds().SetId(3, vpdict['F'][1])  # dl
        polygon_faces.InsertNextCell(q)

        # BR
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['R'][2])
        q.GetPointIds().SetId(1, vpdict['R'][1])
        q.GetPointIds().SetId(2, vpdict['B'][0])
        q.GetPointIds().SetId(3, vpdict['B'][1])
        polygon_faces.InsertNextCell(q)

        # RU
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['R'][3])
        q.GetPointIds().SetId(1, vpdict['R'][2])
        q.GetPointIds().SetId(2, vpdict['U'][1])
        q.GetPointIds().SetId(3, vpdict['U'][0])
        polygon_faces.InsertNextCell(q)

        # RD
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['R'][1])
        q.GetPointIds().SetId(1, vpdict['R'][0])
        q.GetPointIds().SetId(2, vpdict['D'][0])
        q.GetPointIds().SetId(3, vpdict['D'][1])
        polygon_faces.InsertNextCell(q)

        # FD
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['F'][0])
        q.GetPointIds().SetId(1, vpdict['F'][3])
        q.GetPointIds().SetId(2, vpdict['D'][3])
        q.GetPointIds().SetId(3, vpdict['D'][0])
        polygon_faces.InsertNextCell(q)

        # BD
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['B'][3])
        q.GetPointIds().SetId(1, vpdict['B'][0])
        q.GetPointIds().SetId(2, vpdict['D'][1])
        q.GetPointIds().SetId(3, vpdict['D'][2])
        polygon_faces.InsertNextCell(q)
        print('vpdict = %r' % (vpdict,))

        # FU
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['F'][1])
        q.GetPointIds().SetId(1, vpdict['F'][2])
        q.GetPointIds().SetId(2, vpdict['U'][3])
        q.GetPointIds().SetId(3, vpdict['U'][0])
        polygon_faces.InsertNextCell(q)
        ...
        # BU
        q = vtk.vtkQuad()
        q.GetPointIds().SetId(0, vpdict['B'][2])
        q.GetPointIds().SetId(1, vpdict['B'][1])
        q.GetPointIds().SetId(2, vpdict['U'][1])
        q.GetPointIds().SetId(3, vpdict['U'][2])
        polygon_faces.InsertNextCell(q)
...
if __name__ == '__main__':
    r"""
    CommandLine:
        python -m plottool.test_vtk_poly
        python -m plottool.test_vtk_poly --allexamples
