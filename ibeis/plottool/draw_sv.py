...
def draw_svmatch(chip1, chip2, H1=None, H2=None, kpts1=None, kpts2=None,
                 fm=None, fs=None, fm_norm=None, fnum=None,
                 pnum=None, update=False, **kwargs):
    r"""
    Args:
    ...
    Example:
        ...
        >>> # execute function
        >>> result = draw_svmatch(chip1, chip2, H1, H2, kpts1, kpts2)
        >>> # verify results
        >>> print(result)
    ...
    import plottool as pt
    wh2 = gtool.get_size(chip2)
    wh1 = gtool.get_size(chip1)
    # IDEALLY ONLY H1 OR H2 is populated
    chip1_t = gtool.warpHomog(chip1, H1, wh2) if H1 is not None else chip1
    chip2_t = gtool.warpHomog(chip2, H2, wh1) if H2 is not None else chip2
    ...
    pt.show_chipmatch2(chip1_t, chip2_t, kpts1, kpts2, fm=fm, fs=fs,
                       fm_norm=fm_norm, fnum=fnum, H1=H1, H2=H2, pnum=pnum, **kwargs)
