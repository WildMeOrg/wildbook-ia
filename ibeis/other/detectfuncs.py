...
def classifier_cameratrap_precision_recall_algo_display(ibs, positive_imageset_id, negative_imageset_id, figsize=(20, 20)):
    ...
    config_list = [
        ...
        {'label': 'Initial Model (5%)  - DenseNet',   'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v1'},
        # {'label': 'Initial Model (5%)  - DenseNet 0', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v1:0'},
        # {'label': 'Initial Model (5%)  - DenseNet 1', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v1:1'},
        # {'label': 'Initial Model (5%)  - DenseNet 2', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v1:2'},
        {'label': 'Initial Model (10%) - DenseNet',   'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v2'},
        # {'label': 'Initial Model (10%) - DenseNet 0', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v2:0'},
        # {'label': 'Initial Model (10%) - DenseNet 1', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v2:1'},
        # {'label': 'Initial Model (10%) - DenseNet 2', 'classifier_algo': 'densenet', 'classifier_weight_filepath': 'ryan.densenet.v2:2'},
...
def canonical_localization_precision_recall_algo_display(ibs, figsize=(20, 35)):
    ...
    config_list = [
        ...
        {'label': 'CA V2 Ensemble', 'canonical_weight_filepath': 'canonical_zebra_grevys_v2',   'species':canonical_zebra_grevys_v3 'zebra_grevys'},
