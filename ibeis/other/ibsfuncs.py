...
def compute_ggr_path_dict(ibs):
    ...
    county_file_url = 'https://wildbookiarepository.blob.core.windows.net/data/kenyan_counties_boundary_gps_coordinates.zip'
    ...
    # ADD LAND TENURES
    land_tenure_file_url = 'https://wildbookiarepository.blob.core.windows.net/data/kenyan_land_tenures_boundary_gps_coordinates.zip'
