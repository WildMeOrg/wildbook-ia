...
def toy_classify_nans():
    ...
    CommandLine:
        ...
        python -m ibeis.algo.hots.script_vsone toy_classify_nans --toy1 --save "rf_nan_toy1.jpg" --figsize=10,10
        python -m ibeis.algo.hots.script_vsone toy_classify_nans --toy2 --save "rf_nan_toy2.jpg" --figsize=10,10
        python -m ibeis.algo.hots.script_vsone toy_classify_nans --toy2 --save "rf_nan_toy3.jpg" --figsize=10,10 --extra
        python -m ibeis.algo.hots.script_vsone toy_classify_nans --toy2 --save "rf_nan_toy4.jpg" --figsize=10,10 --extra --nanrate=0
        python -m ibeis.algo.hots.script_vsone toy_classify_nans --toy2 --save "rf_nan_toy5.jpg" --figsize=10,10 --nanrate=0
