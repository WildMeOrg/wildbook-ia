...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.algo.hots.qt_inc_automatch
        python -m ibeis.algo.hots.qt_inc_automatch --allexamples
        python -m ibeis.algo.hots.qt_inc_automatch --allexamples --noface --nosrc
    """
