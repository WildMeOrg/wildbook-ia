...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.algo.hots.automatch_suggestor
        python -m ibeis.algo.hots.automatch_suggestor --allexamples
        python -m ibeis.algo.hots.automatch_suggestor --allexamples --noface --nosrc
    """
