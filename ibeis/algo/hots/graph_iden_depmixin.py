...
class _AnnotInfrDepMixin(object):
    ...
    def add_feedback_old(infr, aid1=None, aid2=None, decision=None, tags=[],
        ...
        CommandLine:
            python -m ibeis.algo.hots.graph_iden add_feedback_old
    ...
    def _dynamically_apply_feedback_old(infr, edge, feedback_item, rectify):
        ...
        CommandLine:
            python -m ibeis.algo.hots.graph_iden _dynamically_apply_feedback_old:0
            python -m ibeis.algo.hots.graph_iden _dynamically_apply_feedback_old:1 --show
