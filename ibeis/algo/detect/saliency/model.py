...
class Saliency_Model(JPCNN_Default_Model):
    ...
    def architecture(model, batch_size, in_width, in_height, in_channels,
        ...
        _PretrinedNet = _lasagne.PretrainedNetwork('vggnet_full')
        ...
        l_conv5 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(10),
            # b=_PretrinedNet.get_pretrained_layer(11),
        )
        ...
        l_conv6 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(12),
            # b=_PretrinedNet.get_pretrained_layer(13),
        )
        ...
        l_conv7 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(14),
            # b=_PretrinedNet.get_pretrained_layer(15),
        )
        ...
        l_conv8 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(16),
            # b=_PretrinedNet.get_pretrained_layer(17),
        )
        ...
        l_conv9 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(18),
            # b=_PretrinedNet.get_pretrained_layer(19),
        )
        ...
        l_conv10 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(20),
            # b=_PretrinedNet.get_pretrained_layer(21),
        )
        ...
        l_conv11 = _lasagne.Conv2DLayer(
            ...
            pad=1,
            nonlinearity=_lasagne.nonlinearities.rectify,
            W=_PretrinedNet.get_pretrained_layer(22),
            # b=_PretrinedNet.get_pretrained_layer(23),
        )
