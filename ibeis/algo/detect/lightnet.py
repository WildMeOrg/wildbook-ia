...
CONFIG_URL_DICT = {
    ...
    'vulcan_v0'                  : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.d3e8bf43.v0.py',
    'vulcan_v1'                  : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.d3e8bf43.v1.py',
    'vulcan_d3e8bf43_v0'         : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.d3e8bf43.v0.py',
    'vulcan_d3e8bf43_v1'         : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.d3e8bf43.v1.py',
    'vulcan_5fbfff26_v0'         : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.5fbfff26.v0.py',
    'vulcan_5fbfff26_v1'         : 'https://wildbookiarepository.blob.core.windows.net/models/detect.lightnet.vulcan.5fbfff26.v1.py',
...
def detect(gpath_list, config_filepath=None, weight_filepath=None,
           ...
           flip=False, batch_size=160, **kwargs):
