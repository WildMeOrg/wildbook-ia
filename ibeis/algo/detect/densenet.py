...
ARCHIVE_URL_DICT = {
    'canonical_zebra_grevys_v1' : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.canonical.zebra_grevys.v1.zip',
    ...
    'jaguar_v3'                 : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.jaguar.v3.zip',
    'lynx_v3'                   : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.lynx.v3.zip',
    'manta_v1'                  : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.manta_ray_giant.v1.zip',
    'seaturtle_v3'              : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.seaturtle.v3.zip',
    'hendrik_dorsal_v2'         : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.hendrik_dorsal.v2.zip',
    'nassau_grouper_v0'         : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.grouper_nassau.v0.zip',
    'spotted_dolphin_v0'        : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.dolphin_spotted.v0.zip',
    'spotted_skunk_v0'          : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.skunk_spotted.v0.zip',

    'humpback_dorsal'           : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.whale_humpback.dorsal.v0.zip',

    'seadragon_v0'              : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.seadragon.v0.zip',
    'seadragon_v1'              : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.seadragon.v1.zip',
    'seadragon_v2'              : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.seadragon.v2.zip',

    'jaguar_v4'                 : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.jaguar.v4.zip',
    'lynx_v4'                   : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.lynx.v4.zip',
    'manta_v2'                  : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.manta_ray_giant.v2.zip',
    'seaturtle_v4'              : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.seaturtle.v4.zip',
    'nassau_grouper_v1'         : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.grouper_nassau.v1.zip',
    'spotted_dolphin_v1'        : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.dolphin_spotted.v1.zip',
    'spotted_skunk_v1'          : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.skunk_spotted.v1.zip',

    'iot_v0'                    : 'https://wildbookiarepository.blob.core.windows.net/models/labeler.iot.v0.zip',

    'flukebook_v1'              : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.flukebook.v1.zip',

    'vulcan-d3e8bf43-boost0'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.0.zip',
    'vulcan-d3e8bf43-boost1'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.1.zip',
    'vulcan-d3e8bf43-boost2'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.2.zip',
    'vulcan-d3e8bf43-boost3'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.3.zip',
    'vulcan-d3e8bf43-boost4'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.4.zip',
    'vulcan-d3e8bf43-boost5'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.5.zip',
    'vulcan-d3e8bf43-boost6'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.6.zip',
    'vulcan-d3e8bf43-boost7'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.d3e8bf43.7.zip',

    'vulcan-5fbfff26-boost0'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.5fbfff26.0.zip',
    'vulcan-5fbfff26-boost1'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.5fbfff26.1.zip',
    'vulcan-5fbfff26-boost2'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.5fbfff26.2.zip',
    'vulcan-5fbfff26-boost3'    : 'https://wildbookiarepository.blob.core.windows.net/models/classifier2.vulcan.5fbfff26.3.zip',
}
...
def train(data_path, output_path, batch_size=96, class_weights={}, multi=PARALLEL, sample_multiplier=1.0, **kwargs):
