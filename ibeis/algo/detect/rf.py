...
CONFIG_URL_DICT = {
    # 'localizer-zebra-10'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.10.zip',
    # 'localizer-zebra-20'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.20.zip',
    # 'localizer-zebra-30'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.30.zip',
    # 'localizer-zebra-40'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.40.zip',
    # 'localizer-zebra-50'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.50.zip',
    # 'localizer-zebra-60'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.60.zip',
    # 'localizer-zebra-70'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.70.zip',
    # 'localizer-zebra-80'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.80.zip',
    # 'localizer-zebra-90'  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.90.zip',
    # 'localizer-zebra-100' : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.localization.zebra.100.zip',

    # 'image-zebra'         : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.image.zebra.pkl',

    # 'default'             : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.image.zebra.pkl',
    # None                  : 'https://wildbookiarepository.blob.core.windows.net/models/classifier.rf.image.zebra.pkl',
}
...
def classify(vector_list, weight_filepath, verbose=VERBOSE_SVM, **kwargs):
    ...
    classify_iter = ut.generate2(classify_helper, args_list, nTasks=nTasks,
                                 ordered=True, force_serial=True)
