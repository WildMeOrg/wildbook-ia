...
def compute_and_write_detectimg(ibs, gid_list):
    ...
    CommandLine:
        python -m ibeis.algo.preproc.preproc_detectimg --test-compute_and_write_detectimg --show
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.algo.preproc.preproc_detectimg
        python -m ibeis.algo.preproc.preproc_detectimg --allexamples
        python -m ibeis.algo.preproc.preproc_detectimg --test-compute_and_write_detectimg_lazy
    """
    ut.doctest_funcs()
