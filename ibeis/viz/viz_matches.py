...
def get_query_annot_pair_info(ibs, qaid, qreq_, draw_fmatches, kpts1=None,
    ...
    if (not tblhack or tblhack.lower() in ['bc_dtw', 'oc_wdtw', 'curvrankdorsal', 'curvrankfinfindrhybriddorsal', 'curvrankfluke', 'deepsense', 'finfindr']) and getattr(qreq_, '_isnewreq', None):
