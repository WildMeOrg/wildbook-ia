...
def show_constrained_match(ibs, aid1, aid2, H1=None, H2=None, fm=None, **kwargs):
    """
    Args:
    ...
    Example:
        ...
        >>> # execute function
        >>> result = show_constrained_match(ibs, aid1, aid2, H1=H1, H2=H2, fm=fm)
        >>> # verify results
        >>> print(result)
    ...
    chip1, chip2 = ibs.get_annot_chips((aid1, aid2))
    kpts1, kpts2 = ibs.get_annot_kpts((aid1, aid2))
    draw_sv.draw_svmatch(chip1, chip2, H1=H1, H2=H2, kpts1=kpts1, kpts2=kpts2, fm=fm, **kwargs)
