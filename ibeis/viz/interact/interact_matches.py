...
import six
#import guitool
from plottool import viz_featrow  # NOQA
...
from plottool import abstract_interaction  # TODO  # NOQA
from plottool import interact_matches  # TODO
...
MatchInteraction2 = interact_matches.MatchInteraction2
...
class MatchInteraction(MatchInteraction2):
    """
    ...
    def on_click_inside(self, event, ax):
        ...
        if is_match_type and ctrl_down:
            ...
            super(MatchInteraction, self).on_click_inside(event, ax)
        #elif is_match_type:
        #    if len(self.fm) == 0:
