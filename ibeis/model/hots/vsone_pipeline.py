...
def show_post_vsmany_vser():
    ...
    show_top_chipmatches(qreq_.ibs, qaid2_chipmatch)
...
def testdata_post_vsmany_sver():
    ...
    vsonerr_cfgdict = ut.util_arg.argparse_dict(vsonerr_cfgdict)
    cfgdict.update(vsonerr_cfgdict)
