...
Is my usage of hashing and uuids research and a contribution?  Is it
unimpressive that much of my code is autogenerated?  I feel like I've made these
contributions, but I'm unsure if they should be considered contributions. I
certainly hope at least a subset of the following can be considered
contributions:

    Ease of Programming:
       - Challenge: programing can lead to repatative strain injury and be
         physically painful, this inhibits the amount of code that a programmer
         can generate.

       - Observation and Hypothesis: The less keystrokes a programmer types the
         less injury If code is generated quicker and with
         less keystrokes

       - Goal: Reduce the number of keystrokes

       - Proposed Contributions

        * vim plugins for automatic and documentation code generation
        * new python libraries independent of the current software
