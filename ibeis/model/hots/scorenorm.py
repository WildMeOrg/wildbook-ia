...
def learn_annotscore_normalizer(qreq_, **learnkw):
    ...
    CommandLine:
        python -m ibeis.model.hots.scorenorm --exec-learn_annotscore_normalizer --show

    Example:
        >>> # DISABLE_DOCTEST
        >>> from ibeis.model.hots.scorenorm import *  # NOQA
        >>> import ibeis
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.model.hots.scorenorm
        python -m ibeis.model.hots.scorenorm --allexamples
        python -m ibeis.model.hots.scorenorm --allexamples --noface --nosrc
    """
