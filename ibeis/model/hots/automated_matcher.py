...
Major Tasks:
    Algorithm::
        ...
        * Pipeline needs
            - a move from dict based representation to list based
            - spatial verification cyth speedup
            - nearest neighbor (based on visual uuid caching) caching
     SQL::
         * New Image Columns
