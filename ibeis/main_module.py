...
#@profile
def _init_ibeis(dbdir=None, verbose=None, use_cache=True, web=False, web_browser=False, **kwargs):
    import utool as ut
    from ibeis import params
    ...
    if dbdir is None:
        ...
        if params.args.webapp or web:
            ...
            app.start_from_ibeis(ibs, port=port, browser=web_browser, **kwargs)
    return ibs
...
def opendb(db=None, dbdir=None, defaultdb='cache', allow_newdir=False,
           ...
           web=False, web_browser=False, **kwargs):
    """
    ...
    ibs = _init_ibeis(dbdir, verbose=verbose, use_cache=use_cache, web=web, web_browser=web_browser, **kwargs)
    return ibs
