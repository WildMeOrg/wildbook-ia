...
def convert_vulcan2018_to_ibeis(vulcan_path, dbdir=None, purge=False,
    ...
    CommandLine:
        python -m ibeis convert_vulcan2018_to_ibeis

    Example:
        >>> # SCRIPT
        >>> from ibeis.dbio.ingest_vulcan import *  # NOQA
        >>> default_vulcan_path = join('/', 'data', 'raw', 'processed', 'Vulcan_Elephants')
...
def convert_vulcan2019_to_ibeis(vulcan_path, dbdir=None, purge=False,
                                dry_run=False, **kwargs):
    r"""Convert the raw Vulcan (2019) data to an ibeis database.
    ...
    CommandLine:
        python -m ibeis convert_vulcan2019_to_ibeis
