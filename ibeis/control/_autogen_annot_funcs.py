...
TemplateInfo:
    autogen_time = 12:55:24 2014/11/30
    autogen_key = annot
...
CLASS_INJECT_KEY = ('IBEISController', 'autogen_annot')
...
@register_ibs_method
def get_annot_bboxs(ibs, aid_list):
    """
    ...
    Example:
        ...
        >>> ensure = False
        >>> annot_bbox_list = ibs.get_annot_bboxs(aid_list)
...
@register_ibs_method
def set_annot_bboxs(ibs, aid_list, annot_bbox_list):
