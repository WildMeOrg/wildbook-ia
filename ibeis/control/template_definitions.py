...
getter_template_all_dependants_primary_rowid = ut.codeblock(
    r'''
    # STARTBLOCK
    def get_{root}_{leaf}_rowids({self}, {root}_rowid_list, eager=True, nParams=None):
        """
        get_{root}_{leaf}_rowids

        get {leaf} rowids of {root} under the current state configuration

        getter_template_all_dependants_primary_rowid
...
getter_template_dependants_primary_rowid = ut.codeblock(
    r'''
    # STARTBLOCK
    def get_{root}_{leaf}_rowids({self}, {root}_rowid_list, qreq_=None, ensure=True, eager=True, nParams=None):
        ...
        getter_template_dependants_primary_rowid
...
getter_template_native_rowid_from_superkey = ut.codeblock(
    ...
    def get_{tbl}_rowid_from_superkey({self}, {superkey_args},
        ...
        """
        getter_template_native_rowid_from_superkey
...
getter_template_native_multicolumn = ut.codeblock(
    ...
    def get_{tbl}_{multicol}({self}, {tbl}_rowid_list):
        ...
        getter_template_native_multicolumn
