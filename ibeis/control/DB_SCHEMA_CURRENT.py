"""
AUTOGENERATED ON 13:12:31 2017/05/31
AutogenCommandLine:
...
def update_current(db, ibs=None):
    ...
    db.add_table('parts', [
        ...
        dependsmap={
            'annot_rowid': ('annotations', ('annot_rowid',), ('annot_visual_uuid',)),
    },
    )
