"""
AUTOGENERATED ON 12:12:16 2015/02/23
AutogenCommandLine:
...
def update_current(db, ibs=None):
    ...
    db.add_table(const.ANNOTATION_TABLE, (
        ...
        superkey_colnames_list=[(u'annot_uuid',), (u'annot_uuid',), (u'annot_visual_uuid',)],
        docstr='''
    ...
    db.add_table(const.CONFIG_TABLE, (
        ...
        superkey_colnames_list=[(u'contributor_rowid', u'config_suffix')],
        docstr='''
    ...
    db.add_table(const.CONTRIBUTOR_TABLE, (
        ...
        superkey_colnames_list=[(u'contributor_tag',)],
        docstr='''
    ...
    db.add_table(const.ENCOUNTER_TABLE, (
        ...
        superkey_colnames_list=[(u'encounter_uuid', u'encounter_text')],
        docstr='''
    ...
    db.add_table(const.IMAGE_TABLE, (
        ...
        superkey_colnames_list=[(u'image_uuid',)],
        docstr='''
    ...
    db.add_table(const.NAME_TABLE, (
        ...
        superkey_colnames_list=[(u'name_text',)],
        docstr='''
