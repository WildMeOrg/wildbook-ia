"""
AUTOGENERATED ON 13:05:11 2018/10/08
AutogenCommandLine:
...
def update_current(db, ibs=None):
    ...
    db.add_table('images', [
        ...
        ('image_tile_flag',              'INTEGER DEFAULT 0'),
        ('image_tile_parent_uuid',       'UUID'),
        ('image_tile_xtl',               'INTEGER NOT NULL'),
        ('image_tile_ytl',               'INTEGER NOT NULL'),
        ('image_tile_width',             'INTEGER NOT NULL'),
        ('image_tile_height',            'INTEGER NOT NULL'),
    ],
        docstr='''
