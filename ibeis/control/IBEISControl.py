...
class IBEISController(object):
    ...
    def get_annot_cids(ibs, aid_list, ensure=True, all_configs=False,
                       eager=True, nParams=None, qreq_=None):
    ...
    @getter_1to1
    def get_annot_fids(ibs, aid_list, ensure=False, eager=True, nParams=None, qreq_=None):
    ...
    @getter_1to1
    def get_chip_fids(ibs, cid_list, ensure=True, eager=True, nParams=None, qreq_=None):
        if ensure:
    ...
    #@getter_1toM
    #def get_annot_fgweights(ibs, aid_list, ensure=True, eager=True, nParams=None):
    #    """
    #    Forground Weights
