...
TemplateInfo:
    autogen_time = 14:27:41 2015/03/11
    autogen_key = party
...
@register_ibs_method
def get_party_tags(ibs, party_rowid_list, eager=True, nInput=None):
    ...
    Example:
        ...
        >>> eager = True
        >>> party_tag_list = ibs.get_party_tags(party_rowid_list, eager=eager)
