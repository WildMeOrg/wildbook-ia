...
TemplateInfo:
    autogen_time = 16:31:37 2014/11/29
    autogen_key = featweight

ToRegenerate:
    python -m ibeis.control.template_generator --write
...
CLASS_INJECT_KEY = ('IBEISController', 'autogen_featweight')
