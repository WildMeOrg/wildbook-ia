...
TemplateInfo:
    autogen_time = 14:34:18 2015/03/11
...
@register_ibs_method
@accessor_decors.cache_getter(const.FEATURE_WEIGHT_TABLE, CONFIG_ROWID)
def get_featweight_config_rowids(ibs, featweight_rowid_list, eager=True, nInput=None):
    """ config_rowid_list <- featweight.config_rowid[featweight_rowid_list]

    gets data from the "native" column "config_rowid" in the "featweight" table
    ...
    Example:
        ...
        >>> eager = True
        >>> config_rowid_list = ibs.get_featweight_config_rowids(featweight_rowid_list, eager=eager)
        >>> assert len(featweight_rowid_list) == len(config_rowid_list)
    """
    id_iter = featweight_rowid_list
    colnames = (CONFIG_ROWID,)
    config_rowid_list = ibs.dbcache.get(
        const.FEATURE_WEIGHT_TABLE, colnames, id_iter, id_colname='rowid', eager=eager, nInput=nInput)
    return config_rowid_list


@register_ibs_method
@accessor_decors.cache_getter(const.FEATURE_WEIGHT_TABLE, FEATURE_ROWID)
def get_featweight_feat_rowids(ibs, featweight_rowid_list, eager=True, nInput=None):
    ...
    Example:
        ...
        >>> featweight_rowid_list = ibs._get_all_featweight_rowids()
        >>> eager = True
        >>> feat_rowid_list = ibs.get_featweight_feat_rowids(featweight_rowid_list, eager=eager)
        >>> assert len(featweight_rowid_list) == len(feat_rowid_list)
    """
    id_iter = featweight_rowid_list
...
def get_featweight_fgweights(ibs, featweight_rowid_list, eager=True, nInput=None):
    ...
    Example:
        ...
        >>> featweight_rowid_list = ibs._get_all_featweight_rowids()
        >>> eager = True
        >>> fgweight_list = ibs.get_featweight_fgweights(featweight_rowid_list, eager=eager)
