...
@register_ibs_method
@register_api('/api/image/localize', methods=['PUT'])
...
# @register_api('/api/image/image', methods=['GET'])
...
@register_ibs_method
@accessor_decors.getter_1to1
@register_api('/api/image/gids_from_uuids', methods=['GET'])
