...
TemplateInfo:
    autogen_time = 19:57:09 2015/03/24
...
@register_ibs_method
def add_annotmatch(ibs, aid1_list, aid2_list, annotmatch_truth_list=None, annotmatch_confidence_list=None, annotmatch_is_hard_list=None, annotmatch_is_scenerymatch_list=None, annotmatch_is_photobomb_list=None, annotmatch_is_nondistinct_list=None):
    """
    Returns:
    ...
    colnames = (ANNOT_ROWID1, ANNOT_ROWID2, ANNOTMATCH_TRUTH, ANNOTMATCH_CONFIDENCE, ANNOTMATCH_IS_HARD,
                ANNOTMATCH_IS_SCENERYMATCH, ANNOTMATCH_IS_PHOTOBOMB, ANNOTMATCH_IS_NONDISTINCT,)
    ...
    params_iter = (
        (aid1, aid2, annotmatch_truth, annotmatch_confidence, annotmatch_is_hard,
         annotmatch_is_scenerymatch, annotmatch_is_photobomb, annotmatch_is_nondistinct,)
        for (aid1, aid2, annotmatch_truth, annotmatch_confidence, annotmatch_is_hard, annotmatch_is_scenerymatch, annotmatch_is_photobomb, annotmatch_is_nondistinct,) in
        zip(aid1_list, aid2_list, annotmatch_truth_list, annotmatch_confidence_list, annotmatch_is_hard_list,
            annotmatch_is_scenerymatch_list, annotmatch_is_photobomb_list, annotmatch_is_nondistinct_list)
    )
