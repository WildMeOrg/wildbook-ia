...
TemplateInfo:
    autogen_time = 22:24:50 2014/11/16
...
def get_feat_featweight_rowids(ibs, fid_list, qreq_=None, ensure=False):
    ...
    Timeit:
        ...
        >>> %timeit get_feat_featweight_rowids(ibs, fid_list)
        >>> %timeit ibs.get_feat_featweight_rowids(fid_list)
...
def get_annot_featweight_rowids(ibs, aid_list, qreq_=None, ensure=False):
    ...
    fid_list = ibs.get_annot_fids(aid_list, qreq_=qreq_, ensure=ensure)
    featweight_rowid_list = get_feat_featweight_rowids(
        ibs, fid_list, qreq_=qreq_, ensure=ensure)
    return featweight_rowid_list
