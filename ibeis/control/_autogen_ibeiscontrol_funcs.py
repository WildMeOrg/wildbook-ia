...
TemplateInfo:
    autogen_time = 11:42:03 2014/11/10
...
def get_feat_featweight_rowids(ibs, fid_list, qreq_=None, ensure=False):
    ...
    Timeit:
        ...
        >>> qreq_ = None
        >>> ensure = False
        >>> %timeit get_feat_featweight_rowids(ibs, fid_list, qreq_, ensure)
        >>> %timeit ibs.get_feat_featweight_rowids(fid_list, qreq_, ensure)
    ...
    Example:
        ...
        >>> assert len(featweight_rowid_list) == len(fid_list)
    """
    if ensure:
...
def get_feat_residual_rowids(ibs, fid_list, qreq_=None, ensure=False):
    ...
    Timeit:
        ...
        >>> qreq_ = None
        >>> ensure = False
        >>> %timeit get_feat_residual_rowids(ibs, fid_list, qreq_, ensure)
        >>> %timeit ibs.get_feat_residual_rowids(fid_list, qreq_, ensure)
    ...
    Example:
        ...
        >>> assert len(residual_rowid_list) == len(fid_list)
    """
    if ensure:
...
if __name__ == '__main__':
    """
    CommandLine:
        python .\_autogen_ibeiscontrol_funcs.py
        python .\_autogen_ibeiscontrol_funcs.py --allexamples
    """
