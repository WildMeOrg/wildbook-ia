...
Autogenerated on ymd_hm-2015-11-02_13-50
...
class ExplicitInjectIBEISController(object):
    ...
    def get_annot_hashid_visual_uuid(ibs, aid_list, prefix=u'', _new=False):
        """
    ...
    def get_annot_hashid_semantic_uuid(ibs, aid_list, prefix=u'', _new=False):
        """
    ...
    def get_one_annot_per_name(ibs, col=u'rand'):
        """
    ...
    def get_annot_stats_dict(ibs, aids, prefix=u'', **kwargs):
    ...
    def get_encounter_expanded_aids(ibs, aid_list=None):
        ...
        """
        return ibsfuncs.get_encounter_expanded_aids(ibs, aid_list)

    def get_annot_primary_encounter(ibs, aid_list=None):
        """ """
        return ibsfuncs.get_annot_primary_encounter(ibs, aid_list)
