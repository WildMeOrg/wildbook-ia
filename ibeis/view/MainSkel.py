...
#
# Created: Mon Mar 31 09:29:20 2014
...
class Ui_mainSkel(object):
    def setupUi(self, mainSkel):
        ...
        self.roi_view = QtGui.QWidget()
        self.roi_view.setObjectName(_fromUtf8("roi_view"))
        self.gridLayout_4 = QtGui.QGridLayout(self.roi_view)
        self.gridLayout_4.setObjectName(_fromUtf8("gridLayout_4"))
        self.verticalLayout_3 = QtGui.QVBoxLayout()
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.rids_TBL = QtGui.QTableWidget(self.roi_view)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rids_TBL.sizePolicy().hasHeightForWidth())
        self.rids_TBL.setSizePolicy(sizePolicy)
        self.rids_TBL.setObjectName(_fromUtf8("rids_TBL"))
        self.rids_TBL.setColumnCount(0)
        self.rids_TBL.setRowCount(0)
        self.verticalLayout_3.addWidget(self.rids_TBL)
        self.gridLayout_4.addLayout(self.verticalLayout_3, 0, 0, 1, 1)
        self.tablesTabWidget.addTab(self.roi_view, _fromUtf8(""))
        ...
        self.actionAdd_ROI.setShortcutContext(QtCore.Qt.ApplicationShortcut)
        ...
        self.actionDelete_ROI = QtGui.QAction(mainSkel)
        self.actionDelete_ROI.setShortcutContext(QtCore.Qt.ApplicationShortcut)
        ...
        self.actionPrecomputeROIFeatures = QtGui.QAction(mainSkel)
        self.actionPrecomputeROIFeatures.setShortcutContext(QtCore.Qt.ApplicationShortcut)
        self.actionPrecomputeROIFeatures.setObjectName(_fromUtf8("actionPrecomputeROIFeatures"))
        ...
        self.actionNew_ROI_Property = QtGui.QAction(mainSkel)
        self.actionNew_ROI_Property.setShortcutContext(QtCore.Qt.ApplicationShortcut)
        self.actionNew_ROI_Property.setObjectName(_fromUtf8("actionNew_ROI_Property"))
        ...
        self.menuActions.addAction(self.actionNew_ROI_Property)
        ...
        self.menuActions.addSeparator()
        self.menuActions.addAction(self.actionDelete_ROI)
        self.menuActions.addAction(self.actionDelete_Image)
        self.menuBatch.addAction(self.actionPrecomputeROIFeatures)
    ...
    def retranslateUi(self, mainSkel):
        mainSkel.setWindowTitle(QtGui.QApplication.translate("mainSkel", "IBEIS - No Database Opened", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.rids_TBL.setSortingEnabled(True)
        self.tablesTabWidget.setTabText(self.tablesTabWidget.indexOf(self.roi_view), QtGui.QApplication.translate("mainSkel", "Chip Table", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionAdd_ROI.setText(QtGui.QApplication.translate("mainSkel", "Add Chip", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAdd_ROI.setToolTip(QtGui.QApplication.translate("mainSkel", "When adding a chip, you select an ROI in Image View. The ROI defines a new chip and it is added (but not saved) to the database.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionDelete_ROI.setText(QtGui.QApplication.translate("mainSkel", "Delete Chip", None, QtGui.QApplication.UnicodeUTF8))
        self.actionDelete_ROI.setToolTip(QtGui.QApplication.translate("mainSkel", "Removes a chip from the database. ", None, QtGui.QApplication.UnicodeUTF8))
        self.actionDelete_ROI.setShortcut(QtGui.QApplication.translate("mainSkel", "Ctrl+Del", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionPrecomputeROIFeatures.setText(QtGui.QApplication.translate("mainSkel", "Precompute Chips/Features", None, QtGui.QApplication.UnicodeUTF8))
        self.actionPrecomputeROIFeatures.setToolTip(QtGui.QApplication.translate("mainSkel", "Extracts all chips from images, and computes features. This loads the data into memory and reduces waiting time between selecting chips and images.", None, QtGui.QApplication.UnicodeUTF8))
        self.actionPrecomputeROIFeatures.setShortcut(QtGui.QApplication.translate("mainSkel", "Ctrl+Return", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionNew_ROI_Property.setText(QtGui.QApplication.translate("mainSkel", "New Chip Property", None, QtGui.QApplication.UnicodeUTF8))
        self.actionNew_ROI_Property.setToolTip(QtGui.QApplication.translate("mainSkel", "Creates a new column in the chip table for user properties.", None, QtGui.QApplication.UnicodeUTF8))
