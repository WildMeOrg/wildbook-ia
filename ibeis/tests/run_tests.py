...
def run_tests():
    ...
    if ut.in_pyinstaller_package():
        ...
        doctest_modname_list_ = [
            ...
            'ibeis.algo.preproc.preproc_encounter',
            'ibeis.algo.preproc.preproc_detectimg',
            'ibeis.algo.preproc.preproc_featweight',
            'ibeis.algo.preproc.preproc_image',
            'ibeis.algo.preproc.preproc_feat',
            'ibeis.algo.preproc.preproc_residual',
            'ibeis.algo.preproc.preproc_chip',
            'ibeis.algo.preproc.preproc_probchip',
