...
print, rrr, profile = ut.inject2(__name__, '[TEST_DETECT]')

SPECIAL = ut.get_argflag('--special') or ut.inIPython()
...
def TEST_DETECT(ibs):
    ...
    # if SPECIAL:
    #     gid_list = ut.safe_slice(ibs.get_valid_gids(), 3)
    # #gid_list.extend(ibs.add_images([ut.unixpath('~/Dropbox/Chuck/detect_testimg/testgrevy.jpg')]))
    ...
    #         bbox_list = ut.filter_items(bbox_list2, isthisgid)
...
if __name__ == '__main__':
    ...
    test_locals = ut.run_test(TEST_DETECT, ibs)
