...
def TEST_NEW_SCHEMA(ibs):
    ...
    nid_list = ibs.get_annotion_nids(aid_list, distinguish_unknowns=False)
    print('[TEST] nid_list = %r' % nid_list,)

    gt_list = ibs.get_annotion_groundtruth(aid_list)
    gt_list2 = ibs.get_annotion_groundtruth(aid_list2)
