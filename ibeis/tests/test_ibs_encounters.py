...
def TEST_ENCOUNTERS(ibs):
    ...
    target_enctexts = ['_ENC(1,ms,quant_0.01)0', '_ENC(1,ms,quant_0.01)0-2', '_ENC(1,ms,quant_0.01)0-3', '_ENC(1,ms,quant_0.01)0-4', '_ENC(1,ms,quant_0.01)0-5', '_ENC(1,ms,quant_0.01)0-6', '_ENC(1,ms,quant_0.01)0-7', '_ENC(1,ms,quant_0.01)0-8', '_ENC(1,ms,quant_0.01)0-9', '_ENC(1,ms,quant_0.01)0-10', '_ENC(1,ms,quant_0.01)0-11', '_ENC(1,ms,quant_0.01)0-12', '_ENC(1,ms,quant_0.01)0-13']
    target_gid_uuids = [(UUID('70821b89-f34f-ab57-4575-5384380c592a'), UUID('f2c4658f-a722-793b-8578-c392fd550888'), UUID('08c76203-3614-cada-aace-01d22b3378e2'), UUID('9d3ae88a-8c33-43ef-530e-62dbf916fff2'), UUID('9dd931ae-04d3-4996-3a3a-c6ca4a375ba4'), UUID('145d74ce-b0e0-dce3-9bf5-365599e86b56'), UUID('d35757a5-8f1b-80d5-8b35-9eb8661cb8df'), UUID('5485daf4-3a9a-fa68-196d-79c996f11181'), UUID('aed981a2-4116-9936-6311-e46bd17e25de'), UUID('383dda50-f26b-200a-8baf-548e3ef88f9c'), UUID('672b1bd6-1516-d5fa-14f9-b39594447e23'), UUID('a4597ee8-9e11-c704-efdc-f0d8a1d755b5'), UUID('96735673-dce9-f43a-2cdf-4dc229a0627c'))]
    target_roi_uuids = [(UUID('42a3e2c3-bf75-8f01-6bd1-303a7b30eec2'), UUID('ba47db63-439c-e300-0c13-80a40816a13d'), UUID('0db42bc8-0ee1-8dee-b528-292f87a6d681'), UUID('4bf7a461-6892-352d-e8cd-9d71864df380'), UUID('e0cc89cc-fe0d-b2e9-2a8f-6b19ed03a566'), UUID('cd338bea-16cc-c8e4-e7e3-7ffd92814024'), UUID('9a9b1c0a-dc6a-868d-0858-e5588cad52e8'), UUID('1d24701e-c85a-41ab-a4c6-0559ae00e370'), UUID('10678bf2-597d-a25e-3fff-86929529cfb9'), UUID('27dc2758-0e81-f337-fefb-b75e88581b1a'), UUID('f0ea15bf-5d38-b65f-d157-0c4a3f34755f'), UUID('ccabdf13-798d-152a-b6b1-6b7f106bbff3'), UUID('0e3da848-f9f7-2bca-54cd-8e25ae1403b6'))]
