...
#     CommandLine:
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show --helpx
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show --feat-type=hesaff+siam128
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show --feat-type=hesaff+siam128 --ratio-thresh=.9
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show --feat-type=hesaff+sift --ratio-thresh=.8
#         python -m ibeis.vtool --tf vsone_image_fpath_matching --show --feat-type=hesaff+sift --ratio-thresh=.8
