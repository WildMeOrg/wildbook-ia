...
from ibeis.vtool import linalg as linalgtool
from ibeis.vtool import chip as chiptool
...
def get_grid_kpts(wh=(300, 300), wh_stride=None, scale=20, wh_num=None,
    ...
    CommandLine:
        python -m ibeis.vtool.keypoint get_grid_kpts --show

    Example:
        >>> # DISABLE_DOCTEST
        >>> from ibeis.vtool.keypoint import *  # NOQA
        >>> wh = (300, 300)
        >>> wh_stride = None
        >>> scale = 20
        >>> wh_num = (3, 3)
...
def get_invV_mats2x2(kpts):
    ...
    CommandLine:
        python -m ibeis.vtool.keypoint --test-get_invV_mats2x2
...
def get_invVR_mats2x2(kpts):
    ...
    CommandLine:
        python -m ibeis.vtool.keypoint --test-get_invVR_mats2x2
...
def get_kpts_eccentricity(kpts):
    ...
    CommandLine:
        python -m ibeis.vtool.keypoint --exec-get_kpts_eccentricity --show
...
def get_invVR_mats_oris(invVR_mats):
    ...
    Sympy:
        ...
        >>> from ibeis.vtool.keypoint import *
        >>> import ibeis.vtool as vt
        >>> import sympy
...
def rectify_invV_mats_are_up(invVR_mats):
    ...
    CommandLine:
        python -m ibeis.vtool.keypoint --exec-rectify_invV_mats_are_up --show
...
if __name__ == '__main__':
    """
    CommandLine:
        xdoctest -m ibeis.vtool.keypoint
    """
    import xdoctest
