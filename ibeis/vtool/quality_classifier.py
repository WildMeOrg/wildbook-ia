...
def compute_average_contrast(img):
    """
    CommandLine:
        python -m ibeis.vtool.quality_classifier --exec-compute_average_contrast --show

    Example:
        >>> # ENABLE_DOCTEST
        >>> from ibeis.vtool.quality_classifier import *  # NOQA
...
def fourier_devtest(img):
    ...
    CommandLine:
        python -m ibeis.vtool.quality_classifier --test-fourier_devtest --show
...
if __name__ == '__main__':
    """
    CommandLine:
        xdoctest -m ibeis.vtool.quality_classifier
    """
    import xdoctest
