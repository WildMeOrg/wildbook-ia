...
def svd(M):
    ...
    CommandLine:
        python -m ibeis.vtool.linalg --test-svd

    Example:
        >>> # ENABLE_DOCTEST
        >>> from ibeis.vtool.linalg import *  # NOQA
        >>> # build test data
...
def affine_around_mat3x3(x, y, sx=1.0, sy=1.0, theta=0.0, shear=0.0, tx=0.0,
    ...
    CommandLine:
        python -m ibeis.vtool.linalg affine_around_mat3x3 --show
    CommandLine:
...
def add_homogenous_coordinate(_xys):
    r"""
    CommandLine:
        python -m ibeis.vtool.linalg --test-add_homogenous_coordinate
...
def remove_homogenous_coordinate(_xyzs):
    ...
    CommandLine:
        python -m ibeis.vtool.linalg --test-remove_homogenous_coordinate
