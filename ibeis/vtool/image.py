...
def montage(img_list, dsize, rng=np.random, method='random', return_debug=False):
    ...
    CommandLine:
        python -m ibeis.vtool.image --exec-montage:0 --show
        python -m ibeis.vtool.image --exec-montage:1

    Example:
        >>> # SLOW_DOCTEST
        >>> # xdoctest: +SKIP
        >>> from ibeis.vtool.image import *  # NOQA
...
def imread(img_fpath, grayscale=False, orient=False, flags=None,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-imread
        python -m ibeis.vtool.image --test-imread:1
        python -m ibeis.vtool.image --test-imread:2
...
def imwrite(img_fpath, imgBGR, fallback=False):
    ...
    CommandLine:
        python -m ibeis.vtool.image --exec-imwrite
...
def open_image_size(image_fpath):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-open_image_size
...
def warpAffine(img, Aff, dsize, assume_float01=True):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-warpAffine --show
...
def resized_dims_and_ratio(img_size, max_dsize):
    ...
    CommandLine:
        python -m ibeis.vtool.image resized_dims_and_ratio --show
...
def pad_image_ondisk(img_fpath, pad_, out_fpath=None, value=0,
    ...
    CommandLine:
        python -m ibeis.vtool.image pad_image_ondisk
...
def make_white_transparent(imgBGR):
    ...
    CommandLine:
        python -m ibeis.vtool.image make_white_transparent --show
...
def crop_out_imgfill(img, fillval=None, thresh=0, channel=None):
    ...
    CommandLine:
        python -m ibeis.vtool.image --exec-crop_out_imgfill
...
def clipwhite_ondisk(fpath_in, fpath_out=None, verbose=ut.NOT_QUIET):
    ...
    CommandLine:
        python -m ibeis.vtool.image clipwhite_ondisk
    """
    import ibeis.vtool as vt
...
def rotate_image_ondisk(img_fpath, theta, out_fpath=None, **kwargs):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-rotate_image_ondisk
...
def rotate_image(img, theta, border_mode=None, interpolation=None, dsize=None):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-rotate_image
...
def shear(img, x_shear, y_shear, dsize=None, **kwargs):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-shear --show
...
def affine_warp_around_center(img, sx=1, sy=1, theta=0, shear=0, tx=0, ty=0,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-affine_warp_around_center --show
...
def make_channels_comparable(img1, img2):
    ...
    CommandLine:
        python -m ibeis.vtool.image make_channels_comparable
...
def convert_colorspace(img, colorspace, src_colorspace='BGR'):
    ...
    CommandLine:
        python -m ibeis.vtool.image convert_colorspace --show
...
def padded_resize(img, target_size=(64, 64), interpolation=None):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-padded_resize --show
...
def embed_in_square_image(img, target_size, img_origin=(.5, .5),
    ...
    CommandLine:
        python -m ibeis.vtool.image embed_in_square_image --show
...
def resize_to_maxdims_ondisk(img_fpath, max_dsize, out_fpath=None):
    ...
    CommandLine:
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormA.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormB.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormC.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormD.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormE.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormF.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormG.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormH.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormI.png --dsize=417,None
        python -m ibeis.vtool.image resize_to_maxdims_ondisk --fpath ~/latex/crall-candidacy-2015/figures3/knormJ.png --dsize=417,None
...
def resize_to_maxdims(img, max_dsize=(64, 64),
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-resize_to_maxdims --show
...
def resize_thumb(img, max_dsize=(64, 64), interpolation=None):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-resize_thumb --show
...
def find_pixel_value_index(img, pixel):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-find_pixel_value_index
...
def draw_text(img, text, org, textcolor_rgb=[0, 0, 0], fontScale=1,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-draw_text:0 --show
        python -m ibeis.vtool.image --test-draw_text:1 --show
...
#
#    CommandLine:
#        python -m ibeis.vtool.image --test-testing --show
#
#    Example:
#        >>> # DISABLE_DOCTEST
#        >>> from ibeis.vtool.image import *  # NOQA
...
def perlin_noise(size, scale=32.0, rng=np.random):
    ...
    CommandLine:
        python -m ibeis.vtool.image perlin_noise --show
...
def stack_image_list_special(img1, img_list, num=1, vert=True, use_larger=True,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_image_list_special --show
...
def stack_multi_images2(multiimg_list, offsets_list, sfs_list, vert=True, modifysize=True):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_multi_images2 --show
...
def stack_square_images(img_list, return_info=False, **kwargs):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_square_images
...
def stack_image_list(img_list, return_offset=False, return_sf=False, return_info=False, **kwargs):
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_image_list --show
...
def embed_channels(img, input_channels=(0,), nchannels=3, fill=0):
    ...
    CommandLine:
        python -m ibeis.vtool.image embed_channels --show
...
def ensure_3channel(patch):
    ...
    CommandLine:
        python -m ibeis.vtool.image --exec-ensure_3channel --show
...
def stack_images(img1, img2, vert=None, modifysize=False, return_sf=False,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_images --show
...
def stack_image_recurse(img_list1, img_list2=None, vert=True, modifysize=False,
    ...
    CommandLine:
        python -m ibeis.vtool.image --test-stack_image_recurse --show
...
def filterflags_valid_images(gpaths, valid_formats=None,
    ...
    CommandLine:
        python -m ibeis.vtool.image filterflags_valid_images --show
