...
if DOELSE:
    ...
    from vtool.image import (CV2_INTERPOLATION_TYPES, CV2_WARP_KWARGS,
                             ...
                             blend_images, clipwhite_ondisk,
                             convert_image_list_colorspace, cvt_BGR2L,
                             cvt_BGR2RGB, cvt_bbox_xywh_to_pt1pt2, draw_text,
                             embed_in_square_image, find_pixel_value,
                             get_gpathlist_sizes, get_num_channels,
                             get_round_scaled_dsize, get_scale_factor,
                             get_size, imread, imwrite, imwrite_fallback,
                             open_image_size, open_pil_image,
                             pad_image_on_disk, padded_resize,
                             print_image_checks, resize, resize_image_by_scale,
    ...
    from vtool.linalg import (OLD_pdf_norm2d, TRANSFORM_DTYPE,
                              ...
                              scaleedoffset_mat3x3, shear_mat3x3, svd,
    ...
    from vtool.chip import (compute_chip, extract_chip_from_gpath,
                            extract_chip_from_gpath_into_square,
                            extract_chip_from_img, extract_chip_into_square,
                            get_filter_list, get_scaled_size_with_area,
    ...
    from vtool.geometry import (bbox_from_verts, bboxes_from_vert_list,
                                draw_border, draw_verts, verts_from_bbox,
    ...
    from vtool.other import (and_3lists, and_lists, argsort_multiarray,
                             axiswise_operation2, clipnorm, colwise_operation,
                             ...
                             get_uncovered_mask, index_partition,
                             ...
                             mult_lists, next, norm01, or_lists, pdist_argsort,
                             rebuild_partition, rowwise_operation, trytake,
                             weighted_average_scoring, zipcompress, ziptake,)
