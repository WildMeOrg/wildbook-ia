...
if DOELSE:
    ...
    from vtool.image import (CV2_INTERPOLATION_TYPES, CV2_WARP_KWARGS, 
                             ...
                             make_channels_comparable, montage, 
                             open_image_size, pad_image_on_disk, padded_resize, 
                             ...
                             resize_thumb, resize_to_maxdims, resize_worker, 
    ...
    from vtool.keypoint import (GRAVITY_THETA, KPTS_DTYPE, LOC_DIMS, ORI_DIM, 
                                ...
                                get_kpts_image_extent2, get_kpts_strs, 
    ...
    from vtool.linalg import (OLD_pdf_norm2d, TRANSFORM_DTYPE, 
                              ...
                              inv_ltri, normalize_rows, random_affine_args, 
    ...
    from vtool.math import (beaton_tukey_loss, beaton_tukey_weight, 
                            ...
                            interpolate_nans, iround, logistic_01, 
                            non_decreasing, non_increasing, 
                            strictly_decreasing, strictly_increasing, 
                            test_language_modulus,) 
    from vtool.matching import (MatchTup2, MatchTup3, MatchingError, 
                                PSEUDO_MAX_DIST, PSEUDO_MAX_DIST_SQRD, 
                                PSEUDO_MAX_VEC_COMPONENT, SingleMatch, 
                                assign_spatially_constrained_matches, 
                                assign_unconstrained_matches, empty_neighbors, 
                                ensure_fsv_list, ensure_metadata_feats, 
                                flag_symmetric_matches, make_match_interaction, 
                                marge_matches, namedtuple, 
                                ...
                                vsone_matching2,) 
    from vtool.geometry import (bbox_center, bbox_from_verts, bbox_from_xywh, 
                                bboxes_from_vert_list, closest_point_on_bbox, 
                                closest_point_on_line_segment, 
                                closest_point_on_verts, draw_border, 
    ...
    from vtool.distance import (DEBUG_DIST, L1, L2, L2_root_sift, L2_sift, 
                                L2_sift_sqrd, L2_sqrd, OrderedDict, 
                                TEMP_VEC_DTYPE, VALID_DISTS, bar_L2_sift, 
                                bar_cos_sift, closest_point, compute_distances, 
                                cos_sift, cosine_dist, det_distance, emd, 
                                haversine, hist_isect, nearest_point, 
    ...
    from vtool.other import (and_lists, argsort_groups, argsort_multiarray, 
                             ...
                             find_next_true_indices, flag_intersection, 
                             ...
                             list_compress_, list_take_, median_abs_dev, 
