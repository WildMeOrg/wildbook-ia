...
C:\MinGW\bin\gcc.exe -shared -LC:\Python27\libs -LC:\Python27\PCbuild -lpython27 -static-libgcc -static-libstdc++ -o vtool\_linalg_cyth.pyd
python -c "import vtool"


C:\MinGW\bin\gcc.exe -mdll -O -Wall -IC:\Python27\Lib\site-packages\numpy\core\include -IC:\Python27\include -IC:\Python27\PC -c vtool\_linalg_cyth.c -o vtool\_linalg_cyth.o
C:\MinGW\bin\gcc.exe -shared -s vtool\_linalg_cyth.o vtool\_linalg_cyth.def -LC:\Python27\libs -LC:\Python27\PCbuild -lpython27 -lmsvcr90 -o vtool\_linalg_cyth.pyd


C:\MinGW\bin\gcc.exe -w -Wall -m32 -lpython27 -IC:\Python27\Lib\site-packages\numpy\core\include -IC:\Python27\include -IC:\Python27\PC -IC:\Python27\Lib\site-packages\numpy\core\include -LC:\Python27\libs -o vtool\_linalg_cyth.pyd -c vtool\_linalg_cyth.c
