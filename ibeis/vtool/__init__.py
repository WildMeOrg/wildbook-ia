...
if DOELSE:
    ...
    from vtool.image import (CV2_INTERPOLATION_TYPES, CV2_WARP_KWARGS, 
                             ...
                             clipwhite_ondisk, convert_image_list_colorspace, 
                             cvt_BGR2L, cvt_BGR2RGB, cvt_bbox_xywh_to_pt1pt2, 
                             draw_text, embed_in_square_image, 
                             find_pixel_value, get_gpathlist_sizes, 
                             get_num_channels, get_round_scaled_dsize, 
                             get_scale_factor, get_size, imread, imwrite, 
                             imwrite_fallback, make_channels_comparable, 
                             open_image_size, open_pil_image, 
                             pad_image_on_disk, padded_resize, perlin_noise, 
                             print_image_checks, rectify_to_float01, 
