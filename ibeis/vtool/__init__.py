...
if DOELSE:
    ...
    from vtool.image import (CV2_INTERPOLATION_TYPES, CV2_WARP_KWARGS, 
                             ...
                             find_pixel_value_index, fix_orient_pil_img, 
                             fix_orientation, get_gpathlist_sizes, 
    ...
    from vtool.geometry import (bbox_center, bbox_from_center_wh, 
                                ...
                                get_pointset_extent_wh, get_pointset_extents, 
                                scaled_verts_from_bbox, 
                                scaled_verts_from_bbox_gen, verts_from_bbox, 
    ...
    from vtool.other import (and_lists, argsort_groups, argsort_records, 
                             ...
                             grab_webcam_image, greedy_setcover, 
                             ...
                             norm01, or_lists, pdist_argsort, pdist_indicies, 
                             rebuild_partition, rowwise_operation, safe_cat, 
                             safe_extreme, safe_max, safe_min, safe_pdist, 
                             safe_vstack, take2, to_undirected_edges, trytake, 
