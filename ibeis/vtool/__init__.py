...
from vtool.demodata import get_dummy_kpts
...
from vtool.other import (and_lists, argsort_groups, argsort_records,
                         ...
                         multigroup_lookup_naive, nonunique_row_flags,
                         nonunique_row_indexes, norm01, or_lists, pad_vstack,
                         rebuild_partition, rowwise_operation, safe_cat,
                         safe_div, safe_extreme, safe_max, safe_min,
                         safe_vstack, structure_rows, take2, take_col_per_row,
