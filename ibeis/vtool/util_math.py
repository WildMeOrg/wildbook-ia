...
def interpolate_nans(arr):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --exec-interpolate_nans

    Example:
        >>> # DISABLE_DOCTEST
        >>> from ibeis.vtool.util_math import *  # NOQA
...
def ensure_monotone_strictly_increasing(arr_, left_endpoint=None, right_endpoint=None, zerohack=False, onehack=False, newmode=True):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-ensure_monotone_strictly_increasing --show
        python -m ibeis.vtool.util_math --test-ensure_monotone_strictly_increasing --show --offset=0
...
def ensure_monotone_strictly_decreasing(arr_, left_endpoint=None, right_endpoint=None):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-ensure_monotone_strictly_decreasing --show
...
def breakup_equal_streak(arr_in, left_endpoint=None, right_endpoint=None):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --exec-breakup_equal_streak
        python -m ibeis.vtool.util_math --test-ensure_monotone_strictly_increasing --show --offset=0
...
def group_consecutive(arr):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --exec-group_consecutive
...
def ensure_monotone_increasing(arr_, fromright=True, fromleft=True, newmode=True):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-ensure_monotone_increasing --show
...
def ensure_monotone_decreasing(arr_, fromleft=True, fromright=True):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-ensure_monotone_decreasing --show
...
def iceil(num, dtype=np.int32):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-iceil
...
def gauss_func1d(x, mu=0.0, sigma=1.0):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-gauss_func1d

    CommandLine:
        python -m ibeis.vtool.util_math --test-gauss_func1d --show
...
def gauss_func1d_unnormalized(x, sigma=1.0):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --test-gauss_func1d_unnormalized --show
...
def logistic_01(x):
    ...
    CommandLine:
        python -m ibeis.vtool.util_math --exec-logistic_01 --show
...
if __name__ == '__main__':
    """
    CommandLine:
        xdoctest -m ibeis.vtool.util_math
    """
    import xdoctest
