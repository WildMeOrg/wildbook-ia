...
python -c "import ibeis.vtool, doctest; print(doctest.testmod(vtool.nearest_neighbors))"
"""
...
import ubelt as ub
import numpy as np
from ibeis.vtool._pyflann_backend import FLANN_CLS, pyflann
...
def ann_flann_once(dpts, qpts, num_neighbors, flann_params={}):
    ...
    Example0:
        >>> # ENABLE_DOCTEST
        >>> from ibeis.vtool.nearest_neighbors import *  # NOQA
        >>> np.random.seed(1)
...
def get_flann_cfgstr(dpts, flann_params, cfgstr='', use_params_hash=True,
    ...
    CommandLine:
        python -m ibeis.vtool.nearest_neighbors --test-get_flann_cfgstr
...
def flann_augment(dpts, new_dpts, cache_dir, cfgstr, new_cfgstr, flann_params,
    ...
    Example:
        >>> # DISABLE_DOCTEST
        >>> from ibeis.vtool.nearest_neighbors import *  # NOQA
        >>> import ibeis.vtool.demodata as demodata  # NOQA
...
def get_flann_params(algorithm='kdtree', **kwargs):
    ...
    CommandLine:
        python -m ibeis.vtool.nearest_neighbors --test-get_flann_params --algo=kdtree
        python -m ibeis.vtool.nearest_neighbors --test-get_flann_params --algo=kmeans
...
def tune_flann(dpts,
    ...
    CommandLine:
        python -m ibeis.vtool.nearest_neighbors --test-tune_flann
...
def flann_index_time_experiment():
    ...
    CommandLine:
        python -m ibeis.vtool.nearest_neighbors --test-flann_index_time_experiment
...
if __name__ == '__main__':
    """
    CommandLine:
        xdoctest -m ibeis.vtool.nearest_neighbors
    """
    import xdoctest
