...
from ibeis.vtool._pyflann_backend import FLANN_CLS
...
def groupedzip(id_list, datas_list):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 --test-groupedzip

    Example:
        >>> # ENABLE_DOCTEST
        >>> from ibeis.vtool.clustering2 import *  # NOQA
        >>> # build test data
...
def find_duplicate_items(item_arr):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 --test-find_duplicate_items
...
def apply_grouping(items, groupxs, axis=0):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 --test-apply_grouping
...
def invert_apply_grouping(grouped_items, groupxs):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 --test-invert_apply_grouping
...
def uniform_sample_hypersphere(num, ndim=2, only_quadrent_1=False):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 --test-uniform_sampe_hypersphere
...
def unsupervised_multicut_labeling(cost_matrix, thresh=0):
    ...
    CommandLine:
        python -m ibeis.vtool.clustering2 unsupervised_multicut_labeling --show
...
if __name__ == '__main__':
    ...
    CommandLine:
        ...
        python -m ibeis.vtool.clustering2 all
    """
    import xdoctest
