...
def argsubmax(ydata, xdata=None):
    ...
    Example:
        >>> # ENABLE_DOCTEST
        >>> from ibeis.vtool.histogram import *  # NOQA
        >>> ydata = [ 0,  1,  2, 1.5,  0]
...
def argsubmaxima(hist, centers=None, maxima_thresh=None, _debug=False):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram argsubmaxima
        python -m ibeis.vtool.histogram argsubmaxima --show
...
def hist_argmaxima(hist, centers=None, maxima_thresh=None):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram hist_argmaxima
...
def interpolate_submaxima(argmaxima, hist_, centers=None):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram --test-interpolate_submaxima --show
...
def show_hist_submaxima(hist_, edges=None, centers=None, maxima_thresh=.8, pnum=(1, 1, 1)):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram --test-show_hist_submaxima --show
        python -m pyhesaff._pyhesaff --test-test_rot_invar --show
        python -m ibeis.vtool.histogram --test-show_hist_submaxima --dpath figures --save ~/latex/crall-candidacy-2015/figures/show_hist_submaxima.jpg
...
def interpolated_histogram(data, weights, range_, bins,
    ...
    CommandLine:
        python -m ibeis.vtool.histogram --test-interpolated_histogram
...
def wrap_histogram(hist_, edges_, _debug=False):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram --test-wrap_histogram
...
def subbin_bounds(z, radius, low, high):
    ...
    CommandLine:
        python -m ibeis.vtool.histogram --test-subbin_bounds
...
def show_ori_image_ondisk():
    r"""
    CommandLine:
        python -m ibeis.vtool.histogram --test-show_ori_image_ondisk --show

        python -m ibeis.vtool.histogram --test-show_ori_image_ondisk --show --patch_img_fpath patches/KP_0_PATCH.png --ori_img_fpath patches/KP_0_orientations01.png --weights_img_fpath patches/KP_0_WEIGHTS.png --grady_img_fpath patches/KP_0_ygradient.png --gradx_img_fpath patches/KP_0_xgradient.png --title cpp_show_ori_ondisk
...
if __name__ == '__main__':
    """
    CommandLine:
        xdoctest -m ibeis.vtool.histogram
    """
    import xdoctest
