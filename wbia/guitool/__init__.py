...
if DOELSE:
    ...
    from wbia.guitool.guitool_main import (GUITOOL_PYQT_VERSION, GuitoolApplication,
    ...
    from wbia.guitool.guitool_components import (ALIGN_DICT, BlockSignals,
    ...
    from wbia.guitool.guitool_dialogs import (ResizableMessageBox, SELDIR_CACHEID,
                                         ...
                                         user_question,)
    from wbia.guitool.guitool_decorators import (DEBUG, checks_qt_error, signal_,
                                            slot_,)
    from wbia.guitool.guitool_misc import (ALT_KEY, BlockContext, GUILoggingHandler,
    ...
    from wbia.guitool.api_item_model import (APIItemModel, API_MODEL_BASE,
                                        ChangeLayoutContext, QVariantHack,
                                        VERBOSE_MODEL,
                                        default_method_decorator,
                                        simple_thumbnail_widget, updater,)
    from wbia.guitool.api_tree_view import (APITreeView, API_VIEW_BASE,
                                       testdata_tree_view,)
    from wbia.guitool.api_table_view import (APITableView,)
    from wbia.guitool.qtype import (ItemDataRoles, LOCALE, QLocale, QString,
    ...
    from wbia.guitool.stripe_proxy_model import (STRIPE_PROXY_BASE,
