...
ARCHIVE_URL_DICT = {
    ...
    'msv2_multilabel_effnet_v0': 'https://wildbookiarepository.blob.core.windows.net/models/labeler_msv2_multilabel_effnet.v2.zip',
    'msv2_multilabel_flip_effnet_v0': 'https://wildbookiarepository.blob.core.windows.net/models/labeler_msv2_multilabel_flip_effnet.v2.zip',
