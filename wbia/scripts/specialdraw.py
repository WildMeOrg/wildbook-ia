...
def double_depcache_graph():
    ...
    node_alias = {
        ...
        'CurvRankTwo': 'CurvRank V2 Distance',
        'CurvRankTwoDorsal': 'CurvRank V2 (Dorsal) Distance',
        'CurvRankTwoFluke': 'CurvRank V2 (Fluke) Distance',
    ...
    node_alias = {
        ...
        'CurvRankTwo': 'curvrank_two_distance',
        'CurvRankTwoDorsal': 'curvrank_two_distance_dorsal',
        'CurvRankTwoFluke': 'curvrank_two_distance_fluke',
