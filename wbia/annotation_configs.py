...
def compress_aidcfg(acfg, filter_nones=False, filter_empty=False, force_noncommon=[]):
    ...
    CommandLine:
        ...
        python -m wbia.annotation_configs --exec-compress_aidcfg --show

    Example:
        >>> # DISABLE_DOCTEST
        >>> from wbia.annotation_configs import *  # NOQA
        >>> acfg = default
...
def print_acfg_list(
    ...
    **kwargs
    ...
    CommandLine:
        python -m wbia.annotation_configs --exec-print_acfg_list
