...
SPECIES_MAPPING = {
    ...
    'turtle_green+head': ('ST-G+H', 'Sea Turtle Head (Green)'),
    'turtle_hawksbill+head': ('ST-HB+H', 'Sea Turtle Head (Hawksbill)'),
    'turtle_oliveridley+head': ('ST-HB+H', 'Sea Turtle Head (Olive Ridley)'),
    'train': ('TRAIN', 'Train'),
    'truck': ('TRUCK', 'Truck'),
