...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.algo.preproc.preproc_probchip
        python -m ibeis.algo.preproc.preproc_probchip --allexamples
        python -m ibeis.algo.preproc.preproc_probchip --allexamples --serial --noface --nosrc
    """
