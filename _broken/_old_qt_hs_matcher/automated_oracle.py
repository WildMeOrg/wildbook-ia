...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis.algo.hots.automated_oracle
        python -m ibeis.algo.hots.automated_oracle --allexamples
        python -m ibeis.algo.hots.automated_oracle --allexamples --noface --nosrc
    """
