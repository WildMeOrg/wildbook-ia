...
Theader_ibeiscontrol = ut.codeblock(
    ...
    print, rrr, profile = ut.inject2(__name__, '[autogen_{autogen_key}]')
    ...
    def testdata_{autogen_key}(defaultdb='testdb1'):
        import ibeis
...
Tadder_pl_dependant = ut.codeblock(
    ...
    def add_{parent}_{leaf}({self}, {parent}_rowid_list, config2_=None, verbose=not ut.QUIET, return_num_dirty=False):
        ...
        dirty_{parent}_rowid_list = ut.compress({parent}_rowid_list, isdirty_list)
